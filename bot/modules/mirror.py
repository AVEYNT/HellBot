...
from bot.helper.telegram_helper.message_utils import sendMessage, editMessage, sendMarkup, delete_all_messages, update_all_messages, auto_delete_message, auto_delete_upload_message, sendStatusMessage
    ...
    def onUploadComplete(self, link: str, size, files, folders, typ, name: str):
        ...
        if self.isLeech:
            ...
            if ospath.isdir(f'{DOWNLOAD_DIR}{self.uid}/{name}'):
                ...
                msg += f'\n<b>Files: </b>{files}'
            link = short_url(link)
            buttons.buildbutton("🔷 Download", link)
            ...
            if INDEX_URL is not None:
                ...
                if ospath.isdir(f'{DOWNLOAD_DIR}/{self.uid}/{name}'):
                    ...
                    if VIEW_LINK:
                        ...
                        buttons.buildbutton("♦️ Stream", share_urls)
